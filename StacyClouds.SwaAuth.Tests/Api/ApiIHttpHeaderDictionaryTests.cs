...
{
    [Fact]
    public void TryParseHttpHeaderForClientPrincipal_WithValidIHeaderDictionary_LowerCase_ReturnsTrue()
    {
        // Arrange
    ...
    [Fact]
    public void TryParseHttpHeaderForClientPrincipal_WithValidIHeaderDictionary_UpperCase_ReturnsTrue()
    {
        // Arrange
        var headers = new MockHeaderDictionary();
        var clientPrincipal = new ClientPrincipal
